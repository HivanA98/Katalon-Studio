...
WebUI.click(findTestObject('Manufactur/Process Type/Table_Day'))
...
WebUI.click(findTestObject('Manufactur/Process Type/Table_Time'))
...
WebUI.click(findTestObject('Manufactur/Process Type/Table_Weight'))
