...
WebUI.verifyElementText(findTestObject('Object Repository/Hero Ku App/h1_CURA Healthcare Service'), GlobalVariable.URL)
...
WebUI.click(findTestObject('Object Repository/Hero Ku App/input_Medicaid_programs'))
