...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_Swag Labs/input_Swag Labs_password'), GlobalVariable.WrongPassword)

WebUI.click(findTestObject('Object Repository/Page_Swag Labs/input_Swag Labs_login-button'))

WebUI.verifyElementPresent(findTestObject('Page_Swag Labs/AlertWrongLogin'), 0)
